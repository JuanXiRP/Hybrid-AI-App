...
val OnPrimaryContainerText = Color(0xFFA8E7C5)

val SecondaryBrand = Color(0xFF3F6653)
val OnSecondaryText = Color(0xFFFFFFFF)
val SecondaryContainer = Color(0xFFBEEAD1)

val ErrorRed = Color(0xFFBA1A1A)
val ErrorContainer = Color(0xFFFFDAD6)

// UI Elements
val OutlineBorder = Color(0xFF707973)