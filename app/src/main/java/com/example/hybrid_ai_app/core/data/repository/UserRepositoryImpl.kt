...
class UserRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateProfile(payload: ProfileUpdateRequest): Result<Unit> = try {
    ...
    override suspend fun generateAiPlan(planDuration: Int, goal: String): Result<Unit> = try {
    ...
    override suspend fun getUserProfile(): Result<UserDto> = try {
    ...
    override suspend fun getEntitlement(): Result<Entitlement> = try {
